 ...
 * Slug: blockskit-fitness/template-single-product
 * Categories: template
 * Inserter: false
 */
...
<!-- wp:cover {"url":"<?php echo esc_url($blockskit_fitness_images[0]); ?>","id":79,"dimRatio":80,"overlayColor":"foreground","focalPoint":{"x":0.5,"y":0},"minHeight":480,"align":"full","style":{"spacing":{"margin":{"bottom":"var:preset|spacing|large"},"padding":{"top":"var:preset|spacing|large","bottom":"var:preset|spacing|large"}}},"layout":{"type":"constrained"}} -->
...
<h1 class="wp-block-heading has-text-align-center"><?php esc_html_e( 'Single Product', 'blockskit-fitness' ); ?></h1>
<!-- /wp:heading --></div></div>
<!-- /wp:cover -->
...
<h2 class="wp-block-heading"><?php echo esc_html__( 'Related products', 'blockskit-fitness' ); ?></h2>
<!-- /wp:heading -->
