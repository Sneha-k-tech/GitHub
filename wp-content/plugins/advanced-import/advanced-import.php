...
define( 'ADVANCED_IMPORT_VERSION', '2.0.0' );
...
$advanced_import_upload_dir   = wp_upload_dir();
$advanced_import_temp         = $advanced_import_upload_dir['basedir'] . '/advanced-import-temp/';
$advanced_import_temp_zip     = $advanced_import_upload_dir['basedir'] . '/advanced-import-temp-zip/';
 ...
 */
function advanced_import_activate() {
 ...
 */
function advanced_import_deactivate() {
	require_once ADVANCED_IMPORT_PATH . 'includes/class-advanced-import-deactivator.php';
	Advanced_Import_Deactivator::deactivate();
}

register_activation_hook( __FILE__, 'advanced_import_activate' );
register_deactivation_hook( __FILE__, 'advanced_import_deactivate' );
