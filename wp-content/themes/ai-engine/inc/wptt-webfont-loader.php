...
if ( ! class_exists( 'AI_Engine_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class AI_Engine_WPTT_WebFont_Loader {
		...
		public function get_remote_url_contents() {
			...
			$ai_engine_contents = wp_remote_retrieve_body( $response );

			return $ai_engine_contents;
		}
...
if ( ! function_exists( 'ai_engine_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function ai_engine_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new AI_Engine_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_styles();
	}
}

if ( ! function_exists( 'ai_engine_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function ai_engine_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new AI_Engine_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
