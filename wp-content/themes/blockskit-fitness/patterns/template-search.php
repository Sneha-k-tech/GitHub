 ...
 * Slug: blockskit-fitness/template-search
 * Categories: template
 * Inserter: false
 */
...
<p class="has-text-align-center has-large-font-size"><?php echo esc_html__( 'Sorry, but nothing matched your search terms. Try another search?', 'blockskit-fitness' ); ?></p>
<!-- /wp:paragraph -->
